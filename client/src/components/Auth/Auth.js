    ...
    render() {
        ...
        return (
            <div className="auth-wrapper">
                ...
                <div className="right">
                    <div className="header">QuizBuzz</div>
                    {page}
                    <div className="new" onClick={this.changeTab}>{this.state.tab === 'signin' ? 'New to QuizBuzz? Sign up here' : 'Have an account? Sign in'}</div>
                </div>
            </div>
        )
    }
