                                ...
                                <div className="img-uploader">
                                    ...
                                    <div className="upload-box">
                                        ...
                                        {this.state.previewSource ?
                                            <img className="display-image" src={this.state.previewSource} alt="Preview"  />
                                            : (this.state.user.avatar && this.state.user.avatar.url ? <img className="display-image" src={this.state.user.avatar.url} alt="User avatar"  />  : <img className="display-image" src={this.state.previewSource}  alt="Preview" /> )}
                                    </div>
                                    <div style={{color: this.state.message === 'Success' ? 'green' : 'red', fontSize: '.8em', margin: '20px 0'}}>{ this.state.message }</div>
                                    <button className="image-btn" onClick={(e) => this.handleSubmitFile(e)}>Save</button>
                                </div>
                            </div>
                        </div>
                    }
